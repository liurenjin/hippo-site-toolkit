...
public class HstRequestContext {
    ...
    private String originalHstRequestUri;
    private boolean isPreview;
    private int cacheExpiresMinutes;

    public HstRequestContext(boolean isPreview, int cacheExpiresMinutes) {
    ...
    public int getCacheExpiresMinutes(){
        return this.cacheExpiresMinutes;
    }
    ...
    public String getOriginalHstRequestUri() {
        return originalHstRequestUri;
    }
    ...
    public void setOriginalRequestUri(String originalHstRequestUri) {
        this.originalHstRequestUri = originalHstRequestUri;
    }
