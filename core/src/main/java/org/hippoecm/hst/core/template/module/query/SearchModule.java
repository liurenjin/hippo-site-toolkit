...
public class SearchModule extends ModuleBase implements Search {
    ...
    protected boolean didYouMeanNeeded = DEFAULT_DIDYOUMEANNEEDED;
    protected boolean excerptNeeded = DEFAULT_EXCERPTNEEDED;
    protected boolean similarNeeded = DEFAULT_SIMILARNEEDED;

    protected boolean keepParameters = DEFAULT_KEEPPARAMETERS;
    protected String pageName = DEFAULT_PAGENAME;
    ...
    protected boolean validStatement = true;
    ...
    public void prepareSearch(PageContext pageContext) {
     ...
     // offset 
        ...
        if (moduleParameters.containsKey(HIGHLIGHT)) {
            ...
            setExcerptNeeded(Boolean.valueOf(show_excerpt));
        }
    }
    ...
    public void prepareStatement(PageContext pageContext) {
        ...
        SearchTimer.log.debug("Preparing search statement took --({})-- ms: {}", (System.currentTimeMillis() - start), statement);
    }
    ...
    public void render(PageContext pageContext, HstRequestContext hstRequestContext) throws TemplateException {
        ...
        try {
            ...
            SearchTimer.log.debug("Execute query took --({})-- ms for q = {}", (System.currentTimeMillis() - start) , q.getStatement());
            ...
            // important debug info in case of performance bottlenecks:
            SearchTimer.log.debug("fetching ({}) searchresults took --({})-- ms to complete.", hits.size(),(System.currentTimeMillis() - start));
