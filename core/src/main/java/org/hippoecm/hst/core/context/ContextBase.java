...
public class ContextBase {
    ...
    private final static String BRACKET_LEFT = "_x005b_";
    private final static String BRACKET_RIGHT = "_x005d_";
	...
	public Node getRelativeNode(String path){
        ...
        relativePath = escapeSpecialCharacters(relativePath);
    ...
    public static String escapeSpecialCharacters(String s) {
        ...
        return s.replace(BRACKET_LEFT, "[").replace(BRACKET_RIGHT, "]");
    }
