...
public class ContextWhereClause {
    ...
    private static String atticNodeUUID; 
    ...
    public String getWhereClause(){
        ...
        try {
            ...
            if(atticNodeUUID == null) {
               if(session.itemExists("/content/attic")) {
                   Item attic = session.getItem("/content/attic");
                   if(attic instanceof Node) {
                       Node atticNode = (Node)attic;
                       if(atticNode.isNodeType("mix:referenceable")) {
                           atticNodeUUID = atticNode.getUUID();
                       }
                   }
               }
            }
        ...
        if(atticNodeUUID != null) {
            contextClauses.append(" and not(@").append(HippoNodeType.HIPPO_PATHS).append("='").append(atticNodeUUID).append("')");
        }
