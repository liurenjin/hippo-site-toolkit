...
import org.hippoecm.hst.core.timers.LinkrewriterTimer;
    ...
    public void doTag() throws JspException, IOException {
        ...
        if( urlMapping == null) {
            ...
            if(staticattr != null ) {
                ...
                LinkrewriterTimer.log.debug("Rewriting staticattr took --({})-- ms for ({})", (System.currentTimeMillis() -start), staticattr);
            }
        } else {
            ...
            if(item!= null) {
                ...
                LinkrewriterTimer.log.debug("Rewriting item took --({})-- ms for ({})", (System.currentTimeMillis() - start ), item.getPath());
            } else if(location != null ) {
            	// location must be a sitemapNodeName
                href = urlMapping.rewriteLocation(location, hstRequestContext, externalize).getUri();
                LinkrewriterTimer.log.debug("Rewriting location took --({})-- ms for ({})", (System.currentTimeMillis() - start ), location);
