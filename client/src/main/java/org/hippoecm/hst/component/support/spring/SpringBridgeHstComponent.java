        ...
        if (delegatedBean == null) {
            ...
            if (delegatedBean == null) {
                if (beanFactory == null && componentManager == null) {
                    ...
                    throw new HstComponentException("Cannot find delegated spring HstComponent bean from the client component manager: " + fqbnParam);
                } else {
                    throw new HstComponentException("Cannot find delegated spring HstComponent bean from either the web application context or the client component manager: " + fqbnParam);
                }
            }
