...
public class FormDataCleanupModule implements ConfigurableDaemonModule {
    ...
    /* Test only */
    public FormDataCleanupModule(Session session, String moduleConfigPath, String cronExpression, long minutesToLive,
                                 String excludePaths)
    ...
    private void scheduleJob() {
        ...
        try {
            ...
            job.getJobDataMap().put(CONFIG_EXCLUDE_PATHS, excludePaths);
    ...
    public static class FormDataCleanupJob implements Job {
        ...
        public void execute(final JobExecutionContext context) throws JobExecutionException {
            ...
            try {
                ...
                String[] excludePaths = ((String) context.getMergedJobDataMap().get(CONFIG_EXCLUDE_PATHS)).split("\\|");
        ...
        private void removeOldFormData(long minutesToLive, String[] excludePaths, Session session) throws RepositoryException {
