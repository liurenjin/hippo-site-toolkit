...
public class TestWebFileValve {
    ...
    // NOTE with HSTTWO-3388 this behavior should change: when there is no hst-whitelist.txt file, no web file is
    // served at all
    @Test
    public void whitelist_not_present_results_in_web_resource_being_served() throws ContainerException, UnsupportedEncodingException {
        expect(webFileBundle.getAntiCacheValue()).andReturn("bundleVersion").anyTimes();
