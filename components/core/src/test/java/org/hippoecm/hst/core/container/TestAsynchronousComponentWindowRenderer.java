...
public class TestAsynchronousComponentWindowRenderer extends AbstractContainerURLProviderTest {
    ...
    public void createAsyncComponentRenderingURL_repeats_current_hstRequest_parameters() {
...

        {
            ...
            assertTrue(urlString.contains("_hn:component-rendering%7Cl1"));
